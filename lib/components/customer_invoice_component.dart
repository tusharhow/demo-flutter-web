...
class CustomerInvoiceComponent extends StatefulWidget {
  ...
  final dueDate;
  @override
  State<CustomerInvoiceComponent> createState() =>
      _CustomerInvoiceComponentState();
}

class _CustomerInvoiceComponentState extends State<CustomerInvoiceComponent> {
  @override
